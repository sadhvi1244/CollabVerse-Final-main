...
const CTASection = () => {
  ...
  return (
    <section className="relative h-[700px] w-full flex items-center justify-center overflow-hidden bg-[#030303]">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Join a vibrant community of creators on CollabVerse and bring your
              innovative ideas to life with intuitive, powerful collaboration
              tools.
            </p>
          </motion.div>
